...
$sql = "SELECT * FROM posts WHERE page_id = 1 ORDER by id DESC LIMIT 5 OFFSET 45";
...
<ul class="pagination pagination-sm">
  ...
  <li><a href="newsletter2.php">2</a></li>
  ...
  <li class="active"><a href="newsletter10.php">10</a></li>
</ul>
</div>
